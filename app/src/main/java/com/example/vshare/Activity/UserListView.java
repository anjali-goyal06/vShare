...
import com.example.vshare.adapters.UsersAdapter;
...
public class UserListView extends AppCompatActivity implements UsersListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.i("chhh", String.valueOf(fullName));
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        ...
                        if (task.isSuccessful() && task.getResult() != null) {
                            ...
                            for (QueryDocumentSnapshot documentSnapshot : task.getResult()) {
                                ...
                                User user = new User();
                                user.name = documentSnapshot.getString("fName");
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    user.sendEmailVerification().addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            Toast.makeText(UserListView.this, "Verification Email has been sent.", Toast.LENGTH_SHORT).show();
                        }
                    }).addOnFailureListener(new OnFailureListener() {
                        @Override
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(UserListView.this, "Error! Email can't be sent. " + e.getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            });
    ...
    private void checkForBatteryOptimizations() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!powerManager.isIgnoringBatteryOptimizations(getPackageName())) {
                AlertDialog.Builder builder = new AlertDialog.Builder(UserListView.this);
